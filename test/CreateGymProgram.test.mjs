...
describe('Gym Program API', () => {
    ...
    describe('POST /api/gym-programs/create', () => {
        ...
        it('should return 400 if program with the same name already exists', (done) => {
            chai.request(baseUrl).post('api/gym-programs/create').send(validProgram).end((err, res) => {
        ...
        it('should return 400 if name is missing or not a string', (done) => {
            chai.request(baseUrl).post('api/gym-programs/create').send({ ...validProgram, name: '' }).end((err, res) => {
                expect(res).to.have.status(400);
        ...
        it('should return 400 for invalid focusBodyPart', (done) => {
            chai.request(baseUrl).post('api/gym-programs/create').send({ ...validProgram, focusBodyPart: 'invalid' }).end((err, res) => {
                expect(res).to.have.status(400);
        ...
        it('should return 400 for invalid intensity', (done) => {
            chai.request(baseUrl).post('api/gym-programs/create').send({ ...validProgram, intensity: 'invalid' }).end((err, res) => {
                expect(res).to.have.status(400);
        ...
        it('should return 400 for invalid difficulty', (done) => {
            chai.request(baseUrl).post('api/gym-programs/create').send({ ...validProgram, difficulty: 'invalid' }).end((err, res) => {
                expect(res).to.have.status(400);
        ...
        it('should return 400 for invalid targetAudience', (done) => {
            chai.request(baseUrl).post('api/gym-programs/create').send({ ...validProgram, targetAudience: 'invalid' }).end((err, res) => {
                expect(res).to.have.status(400);
        ...
        it('should return 400 if reps is not a number or positive number', (done) => {
            chai.request(baseUrl).post('api/gym-programs/create').send({ ...validProgram, reps: 'invalid' || reps <= 0 }).end((err, res) => {
                expect(res).to.have.status(400);
        ...
        it('should return 400 if beginner difficulty has high intensity', (done) => {
            chai.request(baseUrl).post('api/gym-programs/create').send({ ...validProgram, difficulty: 'beginner', intensity: 'high' }).end((err, res) => {
                expect(res).to.have.status(400);
        ...
        it('should return 400 if beginner difficulty has more than 10 reps', (done) => {
            chai.request(baseUrl).post('api/gym-programs/create').send({ ...validProgram, difficulty: 'beginner', reps: 15 }).end((err, res) => {
                expect(res).to.have.status(400);
        ...
        it('should return 400 if intermediatedifficulty has high intensity and more than 20 reps', (done) => {
            chai.request(baseUrl).post('api/gym-programs/create').send({ ...validProgram, difficulty: 'intermediate', intensity: 'high', reps: 25 }).end((err, res) => {
                expect(res).to.have.status(400);
        ...
        it('should return 400 if advanced difficulty does not have high intensity', (done) => {
            chai.request(baseUrl).post('api/gym-programs/create').send({ ...validProgram, difficulty: 'advanced', intensity: 'average' }).end((err, res) => {
                expect(res).to.have.status(400);
        ...
        it('should return 400 if advanced difficulty has less than 15 reps', (done) => {
            chai.request(baseUrl).post('api/gym-programs/create').send({ ...validProgram, difficulty: 'advanced', intensity: 'high', reps: 10 }).end((err, res) => {
                expect(res).to.have.status(400);
